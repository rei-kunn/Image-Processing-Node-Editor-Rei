...
class Node(DpgNodeABC):
    ...
    _model_path_setting = {
        "TBEFN(320x180)": _model_base_path
        + "TBEFN/saved_model_180x320/model_float32.onnx",
        "TBEFN(640x360)": _model_base_path
        + "TBEFN/saved_model_360x640/model_float32.onnx",
        "SCI(320x180)": _model_base_path + "SCI/sci_180x320/sci_180x320.onnx",
        "SCI(640x360)": _model_base_path + "SCI/sci_360x640/sci_360x640.onnx",
        "AGLLNet(256x256)": _model_base_path
        + "AGLLNet/saved_model_256x256/model_float32.onnx",
        "AGLLNet(512x384)": _model_base_path
        + "AGLLNet/saved_model_384x512/model_float32.onnx",
    }

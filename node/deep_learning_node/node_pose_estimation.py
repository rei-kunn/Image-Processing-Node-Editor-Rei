...
class Node(DpgNodeABC):
    ...
    _model_path_setting = {
        "MoveNet(SinglePose Lightning)": _model_base_path
        + "movenet/model/movenet_singlepose_lightning_4.onnx",
        "MoveNet(SinglePose Thunder)": _model_base_path
        + "movenet/model/movenet_singlepose_thunder_4.onnx",
        "MoveNet(MulitPose Lightning)": _model_base_path
        + "movenet/model/movenet_multipose_lightning_1.onnx",
    ...
    def update(
        ...
        result = {}
        if frame is not None:
            results_list = self._model_instance[model_name_with_provider](frame)
